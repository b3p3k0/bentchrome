...
Two ways up, learn both: **jump pads** are the striped caution pyramids — hit one with speed from any side and you're airborne; **ramps** are driveable slopes — no launch, just climb. Gravity takes a small bite going up and pays it back going down, while the surface still matters (a grass ramp is a hill, a snowed one is a prayer). Triangular corner slopes fill the diagonals, so a blocky eight-sided hill is as round as this wasteland needs. Any open ledge is a way down; one storey is free, two costs you.
