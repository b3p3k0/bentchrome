...
- They shoot back: every opponent runs the same arsenal you do — machine gun, missiles, their car's signature special — just on a lazier trigger finger. Cover matters now. They'll trade paint with each other too, but there's a code in the wasteland: nobody finishes a dying rival. That pink slip is yours to collect.
