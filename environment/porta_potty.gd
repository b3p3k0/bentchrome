...
func _draw() -> void:
	...
	draw_rect(Rect2(-18, -24, 9, 9), Color(0.14, 0.42, 0.60))
	draw_rect(Rect2(-18, -24, 9, 9), Color(0.08, 0.28, 0.42), false, 2.0)
	...
	if seed_offset % 8 == 3:
		...
		draw_rect(Rect2(19, -21, 6, 42), Color(0.30, 0.68, 0.86))
		draw_rect(Rect2(19, -21, 6, 42), Color(0.10, 0.34, 0.50), false, 2.0)
		draw_line(Vector2(20, -20), Vector2(20, 20), Color(0.10, 0.34, 0.50), 1.5)
		draw_circle(Vector2(23, 12), 2.5, Color(0.92, 0.82, 0.25))
	draw_rect(Rect2(25, -9, 5, 18), Color(0.45, 0.47, 0.50))
	for x in [-13.0, -6.0, 1.0, 8.0]:
		draw_line(Vector2(x, -25), Vector2(x, -20), Color(0.08, 0.28, 0.42), 2.0)
