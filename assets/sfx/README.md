...
| `announcer_<car>` | campaign finale win (the stadium's rolling YOU WIN) | "<Carname> wins!" — baked PA speech per roster id, generated by `tools/synth_sfx.py announcer()` (espeak-ng on the dev box; the game ships only these oggs) |
