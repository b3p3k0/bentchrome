...
for LEVEL in levels/downtown/downtown.tscn levels/freeway/freeway.tscn levels/suburbs/suburbs.tscn levels/snowy/snowy.tscn levels/depot/depot.tscn levels/dock/dock.tscn levels/chase/buzzard_run.tscn levels/construction/ground_floor_gore.tscn levels/stadium/stadium.tscn levels/tutorial/drivers_ed.tscn; do
