...
const DEF_FILES := ["blunt_blaze", "lackey_cannon", "leap", "mine_jump", "mine_land",
	"missile_homing", "missile_power", "missile_standard", "molotov", "phantom_phire",
	"red_glare", "scythe", "splat_effect", "taser", "toe_jam"]
